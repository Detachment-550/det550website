...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery","jquery-ui","application/third_party/tabulator-master/js/tabulator"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery"),require("jquery-ui"),require("application/third_party/tabulator-master/js/tabulator")):e(jQuery)}(function(e, t, o){e.widget("ui.tabulator",{_create:function(){this.table=new o(this.element[0],this.options);for(var e in o.prototype)"function"==typeof o.prototype[e]&&"_"!==e.charAt(0)&&(this[e]=this.table[e].bind(this.table))},_setOption:function(e, t){console.error("Tabulator jQuery wrapper does not support setting options after the table has been instantiated")},_destroy:function(e, t){this.table.destroy()}})});